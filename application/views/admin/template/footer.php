	...
	<script src="<?= base_url()?>assets/admin/plugins/apexchart/chart-data.js" ></script>

	<!-- Select2 JS -->
	<script src="<?= base_url()?>assets/admin/plugins/select2/js/select2.min.js" ></script>

	<!-- Custom Json Js -->
	<script src="<?= base_url()?>assets/admin/js/jsonscript.js" ></script>

	<!-- Color Picker JS -->
	<script src="<?= base_url()?>assets/admin/plugins/%40simonwep/pickr/pickr.es5.min.js" ></script>
	<script src="assets/admin/plugins/summernote/summernote-lite.min.js"></script>
	<!-- Sticky Sidebar JS -->
	<script src="<?= base_url()?>assets/admin/plugins/theia-sticky-sidebar/ResizeSensor.js" ></script>
	<script src="<?= base_url()?>assets/admin/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js" ></script>
	<!--- Custom Js -->
