                    ...
                    <div class="col-md-12">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h4 class="page-title">Client Testimonials</h4>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <div
                                            ...
                                            <a href="<?= base_url('admin_Dashboard/add_testimonials') ?>" class="btn btn-primary"><i
                                                    class="ti ti-square-rounded-plus me-2"></i>Add Testimonials</a>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("exportExcel").addEventListener("click", function () {
        ...
        let wb = XLSX.utils.table_to_book(table, { sheet: "All Testimonials" });
