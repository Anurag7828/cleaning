...
<head>
    ...
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url()?><?= base_url()?>assets/admin/img/apple-touch-icon.png">

    <!-- Favicon -->
    <link rel="icon" href="<?= base_url()?>assets/admin/img/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url()?>assets/admin/img/favcon.png">
        ...
        <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-01">
                <div
                    ...
                    <form action="<?= base_url('Admin/adminlogin') ?>" method="POST" class="flex-fill">
                        <div class="mx-auto mw-450">
                            <div class="text-center mb-4">
                                <!-- <img src="<?= base_url()?>assets/admin/img/logo.svg" class="img-fluid" alt="Logo"> -->
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="text-center">
                                <p class="fw-medium text-gray">Copyright &copy; 2025 - Namami Software</p>
                            </div>
                        </div>
                    </form>
                </div>
