                            ...
                            <form action="" method="post">
                                ...
                                <div class="border-bottom mb-3">
                                    ...
                                    <!-- <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="col-form-label">Sub Category</label>
                                                <input class="form-control" name="image" type="text" value="<?= ($tag == 'edit' && isset($sub_category[0]['image'])) ? htmlspecialchars($sub_category[0]['image']) : '' ?>" required>
                                            </div>
                                        </div> -->
                                       <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label class="col-form-label">Source <span class="text-danger">*</span></label>
                                                            <select class="select2 form-control" name="source" required>
