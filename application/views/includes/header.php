...
<div id="search-popup" class="search-popup">
    <div class="popup-inner">
        <div class="upper-box clearfix">
            <figure class="logo-box pull-left"><a href="<?= base_url() ?>"><img src="assets/imges/logo.png" alt=""></a>
            </figure>
        ...
        <div class="outer-container">
            <div class="outer-box">
                <div class="menu-left-content">
                    <figure class="logo-box"><a href="<?= base_url() ?>"><img src="assets/imges/logo.png" alt=""></a>
                    </figure>
        ...
        $dservice = $this->CommonModal->getAllRows('service');
                                ...
                                <li class="dropdown"><a href="<?= base_url() ?>">Products</a>
                                    <ul>
                                        ...
                                        foreach ($category as $cate) { ?>
                                            <li class="dropdown">
                                                <a
                                                    href="<?= base_url('category/'.encryptId($cate['id'])) ?>"><?= $cate['name'] ?></a>
                                                <?php
                                                $sub_cate = $this->CommonModal->getRowById('sub_category', 'category', $cate['id']);
                                                if (!empty($sub_cate)) { ?>
                                                    <ul>
                                                        <?php foreach ($sub_cate as $sub) { ?>
                                                            <li><a
                                                                    href="<?= base_url() ?>sub_category/<?= encryptId($sub['id']) ?>"><?= $sub['sub_category'] ?></a>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                <?php } ?>
                ...
                <div class="menu-right-content">
                    ...
                    <div class="btn-box">
                        ...
                        <a href="javascript:void(0);" class="search-box-outer search-toggler">Get a quote<i
